...
export function calculateDosaOrder(type, quantity = 1, isSpicy = false) {
  // Your code here
const dosa = { plain: 40, masala: 60, onion: 50, butter: 70, paper: 90, cheese: 80}

if( typeof type != "string" || !Object.hasOwn(dosa , type)) return null;
if( !Number.isFinite(quantity) || typeof quantity != "number" || quantity <=0) return null;
if (typeof isSpicy !== "boolean") return null;

   const basePrice = dosa[type];
